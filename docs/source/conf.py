            ...
            for cmd in 'manpage',: #'examples':
                os.system(
                    '{} build_{} --cmdsuite {} --manpath {} --rstpath {}'.format(
                        setup_py_path,
                        cmd,
                        'datalad_mihextras:command_suite',
...
project = u"MIH's Datalad Extras"
copyright = u'2020-{}, Michael Hanke'.format(datetime.datetime.now().year)
author = u'Michael Hanke'

# The version info for the project you're documenting, acts as replacement for
# |version| and |release|, also used in various other places throughout the
# built documents.
version = datalad_mihextras.__version__
release = version
